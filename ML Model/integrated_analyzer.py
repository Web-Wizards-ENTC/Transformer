"""
Integrated thermal analysis script combining segmentation and thermal comparison.

This script combines the functionality of segment_transformer.py and analyze.py into a single file.
It performs automated transformer segmentation followed by thermal analysis to detect faults.

Input: baseline.png candidate.png
Output: JSON to stdout with thermal analysis results including segmentation

Features:
- Unsupervised K-means segmentation to isolate transformer components
- HSV-based thermal analysis with warm region detection
- Connected component analysis for fault localization
- Bounding box generation with fault type classification
- Automated result visualization with overlaid annotations

Usage:
    python integrated_analyzer.py baseline.jpg candidate.jpg

Output JSON includes:
- prob: Overall fault probability score
...
- boxInfo: Detailed box information with fault classifications
- faultType: Overall fault classification (loose joint, wire overload, point overload, none)
- segmentedBaseline/Candidate: Paths to segmented images
- saved_image: Path to annotated result image (if boxes detected)
"""
import sys
import json
import base64
...
# =============================================================================
# SEGMENTATION MODULE (from segment_transformer.py)
# =============================================================================
...
# =============================================================================
# THERMAL ANALYSIS MODULE (from analyze.py)
# =============================================================================
